...
function appendCaloriesTableOne() {
  $('#meal-table-one').append(
  `<tr class="cal-data remaining-calories">
  ...
  <tr class="cal-data remaining-calories">
    ...
    <strong><td class="remaining-calories text-center" id="table-one-remaining" colspan="2"></td></strong>
  </tr>`
  )
...
function appendCaloriesTableTwo() {
  ...
  <tr class="cal-data">
    <td class="text-center"><strong>Remaining Calories</td>
    <strong><td class="text-center remaining-calories" id="table-two-remaining" colspan="2"></td></strong>
  </tr>`
  )
...
function appendCaloriesTableThree() {
  ...
  <tr class="cal-data">
    <td class="text-center"><strong>Remaining Calories</td>
    <strong><td class="text-center remaining-calories" id="table-three-remaining" colspan="2"></td></strong>
  </tr>`
  )
...
function appendCaloriesTableFour() {
  ...
  <tr class="cal-data">
    <td class="text-center"><strong>Remaining Calories</td>
    <strong><td class="text-center remaining-calories" id="table-four-remaining" colspan="2"></td></strong>
  </tr>`
  )
